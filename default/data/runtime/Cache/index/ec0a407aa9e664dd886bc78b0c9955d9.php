<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><title>正在跳转到爱淘宝...</title><script src="__STATIC__/js/jquery/jquery.js" type="text/javascript"></script></head><body><?php if($item["click_url"] == ''): ?><div style="visibility:hidden;" ><a data-type="0" biz-itemid="<?php echo ($item["num_iid"]); ?>" data-style="2"  data-tmpl="230x312" style="visibility:hidden;"></a></div><script type="text/javascript">    (function(win,doc){

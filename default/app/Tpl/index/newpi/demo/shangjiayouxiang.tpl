...
<div class="shang_m" style="height:614px;background:#fff;">
	<div class="shang_ml">
		<div class="shang_mla">
			<p>
	...
	<div class="shang_mr" style="border:0">
	       	 	 
		<div style="width:560px;background:#FFF;margin-top:60px;margin-left:130px;border:1px solid #dcdcdc">
			<div class="chanshentop tupian14">
				<div onclick="guanbi()" class="guanbi" style="float:right;width:60px;height:44px;margin-top:0px;margin-right:-30px;">&nbsp;</div>
				<div style="clear:both"></div>
			</div>
			
			<div class="trxa" style="margin:50px auto;width:560px;">
				<p style="font-size:16px;margin:20px 20px 20px;color:#666">尊敬的优惠社用户:
					<span style="color:red;font-size:24px;">吾乃无奈</span>
					<br><br>您绑定的邮箱是：
					<span id="zhifuhao" style="color:red;font-size:24px;">iki******h@qq.com</span>
				</p>

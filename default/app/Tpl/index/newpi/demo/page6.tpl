...
<div class="shang_m">
	...
	<div class="shang_mr" style="border:0">
		<center>
		<div class="shang_mrf tupian11">
			
			<div style="margin-top:90px;">
			 尊贵的会员: <span style="font-weight:900"> </span>欢迎登录个人中心 
			</div>
			
			<div style="margin-top:15px;">
			  <a target="_blank" style="margin-top:10px;color:red;font-size:14px" href="http://mian.youhuishe.com/article.php?id=42">商家怎样快速通过优惠社审核</a>
			</div>

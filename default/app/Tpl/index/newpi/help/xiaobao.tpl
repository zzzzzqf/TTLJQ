...
<load href="/static/newpi/css/hmwl-xb.css" />
<load href="/static/newpi/css/xiaobao.css" />
</head>
<body>
<include file="public:header" /> <include file="public:head_nav" />
<div class="consumer-main">
  <div class="img-show h360"></div>
  <div class="consumer01">
    <div class="xiaobao">
      <div class="xb_icon xb_cons"> <a href="#consumer02" class="xb_s1">商家审核</a> <a href="#consumer03" class="xb_s2">买手砍价</a> <a href="#consumer04" class="xb_s3">验货质检</a> <a href="#consumer05" class="xb_s4">价格监控</a> <a href="#consumer06" class="xb_s5">全国包邮 </a> <a href="#consumer07" class="xb_s6">七天退换</a> <a href="#consumer08" class="xb_s7">闪电发货</a> </div>
    </div>
  </div>
